  ...
  return (
    <div style={{ background: "#0a0e1a", color: "#e2e8f0", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, maxWidth: "1000px", width: "100%", margin: "0 auto", padding: "60px 24px" }}>
        <div style={{ fontSize: "12px", color: "#64748b", fontFamily: "Inter, sans-serif", letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: "8px" }}>
          Learning Resources
        </div>
        <h1 style={{ fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: "40px", color: "#f1f5f9", marginBottom: "16px", letterSpacing: "-0.5px" }}>
          Learn Blyx
        </h1>
        <p style={{ fontFamily: "Inter, sans-serif", fontSize: "18px", color: "#94a3b8", lineHeight: 1.6, marginBottom: "56px", maxWidth: "680px" }}>
        ...
        {/* Section 1 — Get Started (Blue Stripe) */}
        <div style={{ marginBottom: "56px" }}>
          <h2 style={{ fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: "24px", color: "#f1f5f9", marginBottom: "20px" }}>
            1. Get Started
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
            <Link href="/learn/book" style={{ textDecoration: "none" }}>
              <div style={{ padding: "28px", background: "#111827", borderRadius: "8px", border: "1px solid #1e293b", borderLeft: "4px solid #3b82f6", height: "100%" }}>
                <h3 style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: "20px", color: "#f1f5f9", marginBottom: "10px" }}>
                  The Blyx Book →
                </h3>
        ...
        {/* Section 2 — Grow with Blyx (Purple Stripe) */}
        <div style={{ marginBottom: "56px" }}>
          <h2 style={{ fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: "24px", color: "#f1f5f9", marginBottom: "20px" }}>
            2. Grow with Blyx
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
            <Link href="/play" style={{ textDecoration: "none" }}>
              <div style={{ padding: "28px", background: "#111827", borderRadius: "8px", border: "1px solid #1e293b", borderLeft: "4px solid #c084fc", height: "100%" }}>
                <h3 style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: "20px", color: "#f1f5f9", marginBottom: "10px" }}>
        ...
        {/* Section 3 — Master Blyx (Green Stripe) */}
        <div>
          <h2 style={{ fontFamily: "Inter, sans-serif", fontWeight: 700, fontSize: "24px", color: "#f1f5f9", marginBottom: "20px" }}>
            3. Master Blyx
          </h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "24px" }}>
            <Link href="/community" style={{ textDecoration: "none" }}>
              <div style={{ padding: "28px", background: "#111827", borderRadius: "8px", border: "1px solid #1e293b", borderLeft: "4px solid #34d399", height: "100%" }}>
                <h3 style={{ fontFamily: "Inter, sans-serif", fontWeight: 600, fontSize: "20px", color: "#f1f5f9", marginBottom: "10px" }}>
                  RFC Documents →
                </h3>
                <p style={{ fontFamily: "Inter, sans-serif", fontSize: "14px", color: "#94a3b8", lineHeight: 1.6 }}>
